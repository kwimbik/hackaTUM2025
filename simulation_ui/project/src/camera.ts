...
export function isoTransform(worldX: number, yOffset: number = 0): [number, number] {
...
export function areStickmenVisible(canvas: HTMLCanvasElement, timelineOffset: number): boolean {
